...
class Product extends sys_utils
{
            ...
            if (in_array($fileActualExp, $allowed)) {
                if ($fileError === 0) {
                    if ($fileSize < 10000000) {
                        $fileDestination = $this->productModel->uploadImage($file); ###add destination
    ...
    public function addProduct()
    {
        ...
        if (isset($_POST['addproduct-btn'])) {
            ...
            if (
                str_replace("#[,]#", ".", $data['buy_price_p'])  || //replaces "," with "."
            ...
            if (
                str_replace("#[,]#", ".", $data['sell_price_p'])  || //replaces "," with "."
