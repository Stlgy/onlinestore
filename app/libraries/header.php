...
<header>
    <div class="container-fluid">
        <div class="row  justify-content-between">
            ...
            <a href="views/product/view.php"><i class="bi bi-shop-window"></i></a>
            </div>
            <div class="col-md-8 ">
                <nav class="nav-login">
                        ...
                        <?php
                            ...
                            if (!isset($_SESSION['username']) || empty($_SESSION['username'])) {
                                ...
                                ?>  
                                    ...
                                    <li><a class="logs" href="controllers/usersController.php?q=logout">Logout</a></li>
                                    <li><a class="logs" href="update-profile.php">Setthings</a></li>
                                <?php
                            }
                        ?>
                    </ul>
